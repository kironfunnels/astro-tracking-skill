...
1. **Quem processa o envio?** Formulário próprio (Astro + endpoint), embed nativo de um provedor (renderiza na página e envia por `fetch`), **iframe** de outro domínio, formulário hospedado em outra URL, checkout externo.
