// Tracking configuration shared by the browser runtime and the server relay.
...
export const tracking = {
  ...
  /** Relay endpoint (Cloudflare Pages Function or Astro endpoint). Empty string = browser-only tracking. */
  endpoint: '/api/events',
