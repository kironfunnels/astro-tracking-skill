# Auditoria da skill `web-tracking`
...
- **Arquivo:linha:** `skills/web-tracking/templates/adapters/next/app/api/events/route.ts:11`.
...
- **Arquivo:linha:** `skills/web-tracking/templates/core/tracking/events.ts:16-29`; `skills/web-tracking/references/pinterest.md:21-30`.
...
- **Arquivo:linha:** `skills/web-tracking/templates/core/tracking/identity.ts:58-62`; `skills/web-tracking/references/google.md:17`.
...
- **Arquivo:linha:** `skills/web-tracking/references/tiktok.md:32`; `skills/web-tracking/templates/core/tracking/server/tiktok.ts:2`.
...
- **Arquivo:linha:** `skills/web-tracking/templates/core/tracking/platforms/pinterest.ts:38-42`; `skills/web-tracking/templates/core/tracking/server/pinterest.ts:10-14`.
...
- **Arquivo:linha:** `skills/web-tracking/templates/core/tracking/server/microsoft.ts:36`; `skills/web-tracking/references/microsoft.md:23`.
...
- **Arquivo:linha:** `skills/web-tracking/templates/core/tracking/server/relay.ts:204-205`.
...
- **Arquivo:linha:** `skills/web-tracking/templates/core/tracking/server/relay.ts:115-147,184-213`; `skills/web-tracking/templates/core/tracking/server/microsoft.ts:31-38`.
...
- **Arquivo:linha:** `skills/web-tracking/scripts/audit-site.mjs:8-11,48-49,184-189`; `skills/web-tracking/references/audit.md:14`.
...
- **Arquivo:linha:** `skills/web-tracking/templates/core/tracking/server/relay.ts:96-111,121-145`; `skills/web-tracking/templates/core/tracking/client.ts:113-116`; `skills/web-tracking/templates/core/tracking/params.ts:74-84`.
...
- **Arquivo:linha:** `skills/web-tracking/templates/core/tracking/client.ts:148-175,194-204`; `skills/web-tracking/references/consent.md:12`.
...
- **Arquivo:linha:** `skills/web-tracking/templates/core/tracking/client.ts:137-145,170-174,194-204`; `skills/web-tracking/references/consent.md:10-12`.
...
- **Arquivo:linha:** `skills/web-tracking/templates/core/tracking/server/relay.ts:150-156,222-227`.
...
- **Arquivo:linha:** `skills/web-tracking/templates/core/tracking/form-capture.ts:80-99`.
...
- **Arquivo:linha:** `skills/web-tracking/templates/core/tracking/params.ts:41-67,86-87`; `skills/web-tracking/references/params.md:7-16`.
...
- **Arquivo:linha:** `skills/web-tracking/templates/core/tracking/client.ts:254-259`; `skills/web-tracking/SKILL.md:74-77`.
...
- **Arquivo:linha:** `skills/web-tracking/templates/core/tracking/server/meta.ts:12-16`; `skills/web-tracking/references/meta.md:38`.
...
- **Arquivo:linha:** `skills/web-tracking/templates/core/tracking/server/meta.ts:64`.
...
- **Arquivo:linha:** `skills/web-tracking/templates/core/tracking/server/meta.ts:9`; `skills/web-tracking/templates/core/tracking/server/tiktok.ts:8-44`; `skills/web-tracking/references/tiktok.md:5-32`.
...
- **Arquivo:linha:** `skills/web-tracking/templates/core/tracking/platforms/linkedin.ts:19-34`; `skills/web-tracking/templates/core/tracking/platforms/microsoft.ts:31-56`.
